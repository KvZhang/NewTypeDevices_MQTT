...
void LED8X32::HT1632C_show_string(uint8_t *string, uint8_t lenth, bool repeat=true, uint16_t ms=1000)
{
	this->string=string;
	this->length=lenth;
...
void LED8X32::HT1632C_show_handle()
{
	...
	if(millis()-this->start_moment>=this->time_interval)
	{
		...
		this->HT1632C_Writer_AllDATA(0 , zimo_alphabet[time[0]+16], 8);
		this->HT1632C_Writer_AllDATA(16, zimo_alphabet[time[1]+16], 8);
		this->HT1632C_Writer_AllDATA(32, zimo_alphabet[time[2]+16], 8);
		this->HT1632C_Writer_AllDATA(48, zimo_alphabet[time[3]+16], 8);
