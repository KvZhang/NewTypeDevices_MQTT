...
#include "KeyBoardMatrixEvents.h"

KeyBoardMatrixEvents::KeyBoardMatrixEvents(const uint8_t* linePtr,const uint8_t* columnPtr,uint8_t lineNum,uint8_t columnNum)
{
...
bool KeyBoardMatrixEvents::keyHandler()
{
	uint8_t temp=0xff;
...
uint8_t KeyBoardMatrixEvents::readLineInput()
{
	uint8_t temp=0xff;
	for(uint8_t i=0;i<this->lineNumber;i++)
	{
...
uint8_t KeyBoardMatrixEvents::readColumnInput()
{
	uint8_t temp=0xff;
...
uint8_t KeyBoardMatrixEvents::getKey()
{
...
KeyBoardMatrixEvents::~KeyBoardMatrixEvents()
{
